...
namespace BlogProject.Controllers
{
    public class UsersController : Controller
    {
        ...
        bool IsSuccess;
        string _kod;
        public UsersController(IUnitOfWork uow, IEncryptor encrypt, IMailMessage mesaj)
        {
            _uow = uow;
            _mesaj = mesaj;
            _encrypt = encrypt;
        ...
        public ActionResult Register(User model)
        {
            ...
            if (validator.IsValid)
            {
                if (!sorgu)
                {
                    ...
                    model.Kod = _kod;
                    string url = Path.Combine("http://localhost:52502/Users/RegisterConfirm/", "?kod=" + _kod);
        ...
        public ActionResult ForgotPassword(User model)
        {
            ...
            if (validator.IsValid)
            {
                ...
                if (forgotPasswordUserId != 0)
                {
                    ...
                    string url = Path.Combine("http://localhost:52502/Users/PasswordConfirm/", "?kod=" + _kod);
